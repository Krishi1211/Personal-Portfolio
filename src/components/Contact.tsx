...
const contactMethods = [
  {
    icon: Mail,
    label: 'Email',
    value: 'krishishah1211@gmail.com',
    href: 'mailto:krishishah1211@gmail.com',
    bg: 'bg-blue-700',
  ...
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/krishishah1211/',
...
const codingPlatforms = [
  {
    icon: LeetCodeIcon,
    label: 'LeetCode',
    href: 'https://leetcode.com/u/krishishah1211/',
    bg: 'bg-white',
    iconColor: '',
  },
  {
    icon: HackerRankIcon,
    label: 'HackerRank',
    href: 'https://www.hackerrank.com/profile/krishishah1211',
    bg: 'bg-white',
    iconColor: '',
  },
  {
    ...
    href: 'https://stackoverflow.com/users/31633940/krishi-shah',
    bg: 'bg-white',
    iconColor: '',
  },
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: '19caf67e-fb0c-4335-94dc-170c79864608',
